...
`.trimStart(),
  ...
  footer: '╰───────⳹\n',
  after: '*إستخدامك للبوت بشكل صحيح يعني أنك تزيد من إحتمالية أن يبقى البوت شغالا لمدة أطول . لذا إن واجهتك أي مشكلة لا تخجل من سؤال صاحب البوت .رقمه سوف تجده في الأسفل b ك*\n+212614998730',
}
...
externalAdReply: {
title: 'BOBIZA BOT ♥',
body: "ᗪᐯ:ᗷIᒪᗩᒪ ᗰOᑌᗷᗩᖇEK ࿕",
thumbnailUrl: 'https://telegra.ph/file/faa4fcf12e960909ab28b.jpg',
sourceUrl: 'https://instagram.com/127.0.0.1:8888',
mediaType: 1,
renderLargerThumbnail: true
}}}, { quoted: m})
conn.sendMessage(m.chat, {audio: { url: 'https://files.catbox.moe/2rplrz.mp3' }, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
